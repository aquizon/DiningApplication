...
#   before :each do
#     Product.create!(:name => "apple corer", :description => "apple description", :price => 1.99, :minimum_age_appropriate => 3, :release_year => 2000)
#     Product.create!(:name => "banana peeler", :description => "banana description", :price => 2.99, :minimum_age_appropriate => 2, :maximum_age_appropriate => 2, :release_year => 2000)
